...
export default ({ card, addCard, removeCard, setCurrentDeck, currentDeck, setPlayerOneBattlefield, addToBattlefield, setCurrentHand, currentHand, battlefield, index, ...props }) => {
    ...
    if (typeof removeCard == 'undefined') {
        ...
        // } else {
        return (
            <div onMouseEnter={enlargeCard}>
                {card.image_uris ? <img src={card.image_uris.normal} alt="" width='187' height='262' className={cardClass} onClick={() => handleClick(card)} /> : null}
